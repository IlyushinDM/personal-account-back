...
type LabAnalysis struct {
	...
	AppointmentID  sql.NullInt64  `db:"appointment_id" json:"appointmentID,omitzero"`
	...
	ResultFileName sql.NullString `db:"result_file_name" json:"resultFileName,omitzero"`
	ClinicID       sql.NullInt64  `db:"clinic_id" json:"clinicID,omitzero"`
}
